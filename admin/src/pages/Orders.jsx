...
const Orders = ({ token }) => {
  ...
  const downloadReport = () => {
    ...
    doc.text(`© ${new Date().getFullYear()} TA FURNITURE STORE`, 150, pageHeight - 10);
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <p className="text-lg font-medium text-gray-700">
          Total Orders: {orders.length} | Total Revenue: <span className="text-green-600 font-bold">{currency}{totalPrice.toFixed(2)}</span>
        </p>
